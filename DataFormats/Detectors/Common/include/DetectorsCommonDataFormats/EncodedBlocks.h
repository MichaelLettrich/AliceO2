...
Metadata makeMetadataRansCompat(size_t nStreams, size_t messageLength,
                                size_t nLiterals, size_t symbolTablePrecision,
                                source_T min, source_T max, size_t dictWords,
                                size_t dataWords, size_t literalWords)
{
  return Metadata{
...
template <typename source_T, typename state_T, typename stream_T>
Metadata makeMetadataRansV1(size_t nStreams, size_t streamingLowerBound, size_t messageLength,
                            size_t nLiterals, size_t symbolTablePrecision,
...
Metadata makeMetadataPack(size_t messageLength, size_t packingWidth,
                          source_T packingOffset, size_t dataWords)
{
  return Metadata{
...
Metadata makeMetadataStore(size_t messageLength, Metadata::OptStore opStore, size_t dataWords)
{
  return Metadata{
    static_cast<uint8_t>(0),
    messageLength,
...
class EncodedBlocks
{
 public:
  ...
  template <typename source_T>
  rans::RenormedHistogram<source_T> getFrequencyTable(int i) const
  {
    ...
    if (ansVersion == ANSVersionCompat) {
      ...
      throw std::runtime_error("Failed to load serialized Dictionary. Unsupported ANS Version");
    }
  };
