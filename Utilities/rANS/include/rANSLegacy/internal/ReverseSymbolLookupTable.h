...
#ifndef RANSLEGACY_INTERNAL_REVERSESYMBOLLOOKUPTABLE_H
#define RANSLEGACY_INTERNAL_REVERSESYMBOLLOOKUPTABLE_H
...
#endif /* RANSLEGACY_INTERNAL_REVERSESYMBOLLOOKUPTABLE_H */
