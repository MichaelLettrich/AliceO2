...
#ifndef INCLUDE_RANSLEGACY_UTILS_COMBINEDITERATOR_H_
#define INCLUDE_RANSLEGACY_UTILS_COMBINEDITERATOR_H_
...
#endif /* INCLUDE_RANSLEGACY_UTILS_COMBINEDITERATOR_H_ */
