...
#ifndef INCLUDE_RANSLEGACY_FREQUENCYTABLE_H_
#define INCLUDE_RANSLEGACY_FREQUENCYTABLE_H_
...
#include "rANSLegacy/utils/HistogramView.h"
...
#endif /* INCLUDE_RANSLEGACY_FREQUENCYTABLE_H_ */
