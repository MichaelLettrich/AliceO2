...
#ifndef INCLUDE_RANSLEGACY_RENORMEDFREQUENCYTABLE_H_
#define INCLUDE_RANSLEGACY_RENORMEDFREQUENCYTABLE_H_
...
#endif /* INCLUDE_RANSLEGACY_RENORMEDFREQUENCYTABLE_H_ */
