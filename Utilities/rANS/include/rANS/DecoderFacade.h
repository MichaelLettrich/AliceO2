...
#ifndef RANS_DECODERFACADE_H
#define RANS_DECODERFACADE_H
...
class DecoderFacade
{
 public:
  ...
  DecoderFacade() = default;
  template <typename renormedSymbolTable_T>
  DecoderFacade(const renormedSymbolTable_T& renormedFrequencyTable) : mSymbolTable{renormedFrequencyTable}, mReverseLUT{renormedFrequencyTable} {};
 ...
 protected:
  ...
  internal::RLUT<source_type> mReverseLUT{};
