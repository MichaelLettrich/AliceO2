...
template <typename coder_T, typename stream_T, typename source_T>
DecoderBase<coder_T, stream_T, source_T>::DecoderBase(const FrequencyTable& frequencies, size_t probabilityBits) : mProbabilityBits{probabilityBits}
{
  ...
  t.start();
  mReverseLUT = reverseSymbolLookupTable_t{mProbabilityBits, stats};
  t.stop();
