...
class Decoder
{
 public:
  ...
  explicit Decoder(size_type symbolTablePrecission) noexcept : mSymbolTablePrecission{symbolTablePrecission} {};
...
template <size_t LowerBound_V>
template <typename stream_IT>
stream_IT Decoder<LowerBound_V>::init(stream_IT inputIter)
{
...
template <size_t LowerBound_V>
template <typename stream_IT>
inline stream_IT Decoder<LowerBound_V>::advanceSymbol(stream_IT inputIter, const symbol_type& symbol)
{
...
template <size_t LowerBound_V>
template <typename stream_IT>
inline auto Decoder<LowerBound_V>::renorm(state_type state, stream_IT inputIter) -> std::tuple<state_type, stream_IT>
{
  static_assert(std::is_same<typename std::iterator_traits<stream_IT>::value_type, stream_type>::value);
