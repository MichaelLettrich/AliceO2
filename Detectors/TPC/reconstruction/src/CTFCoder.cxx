...
size_t CTFCoder::estimateCompressedSize(const CompressedClusters& ccl)
{
  ...
  sz += estimateBufferSize(CTF::BLCqMaxA, ccl.qMaxA, ccl.qMaxA + ccl.nAttachedClusters);
  ...
  sz += estimateBufferSize(CTF::BLCsliceLegDiffA, ccl.sliceLegDiffA, ccl.sliceLegDiffA + ccl.nAttachedClustersReduced);
  ...
  sz += estimateBufferSize(CTF::BLCsigmaTimeA, ccl.sigmaTimeA, ccl.sigmaTimeA + ccl.nAttachedClusters);
  ...
  sz += estimateBufferSize(CTF::BLCqMaxU, ccl.qMaxU, ccl.qMaxU + ccl.nUnattachedClusters);
