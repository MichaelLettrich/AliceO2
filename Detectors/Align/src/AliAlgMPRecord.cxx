...
AliAlgMPRecord::AliAlgMPRecord()
  : fTrackID(0), fTimeStamp(0), fNResid(0), fNVarLoc(0), fNVarGlo(0), fNDLocTot(0), fNDGloTot(0), fNMeas(0), fChi2Ini(0), fQ2Pt(0), fTgl(0), fNDLoc(0), fNDGlo(0), fVolID(0), fResid(0), fResErr(0), fIDLoc(0), fIDGlo(0), fDLoc(0), fDGlo(0)
    //
    ,
    fNResidBook(0),
    fNDLocTotBook(0),
